...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="140px 0 110px 0" sm-padding="40px 0" background="url(https://images.unsplash.com/photo-1605019460098-6650e17d7dcd?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&w=2000) center/cover" position="sticky">
